...
namespace CPWizard
{
    class CmdManager : IDisposable
    {
        ...
        public bool IsFirstInstance()
        {
            ...
            {
                LogFile.WriteLine("IsFirstInstance", "CmdManager", ex.Message, ex.StackTrace);
            }
        ...
        public void OnChanged(string str)
        {
            ...
            {
                LogFile.WriteLine("OnChanged", "CmdManager", ex.Message, ex.StackTrace);
            }
        }
        ...
        public Dictionary<string, string> CmdLineToHash(string[] args)
        {
            ...
            {
                LogFile.WriteLine("CmdLineToHash", "CmdManager", ex.Message, ex.StackTrace);
            }
